...
In the fixed snapshot, v1/v2 are available for two overlapping judge/model slices: ChatGPT-as-judge on Gemini outputs and Gemini-as-judge on ChatGPT outputs, while the remaining slices are available only under v0.
