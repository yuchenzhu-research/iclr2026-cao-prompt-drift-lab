...
% Fix for the workshop header on the first page and subsequent pages
\makeatletter
\fancyhead[L]{Published as a conference paper at CAO Workshop at ICLR 2026}
\thispagestyle{fancy}
\makeatother
...
Code, prompts, processed evaluation snapshots, and figure-generation scripts are available in our public GitHub repository: \url{https://github.com/yuchenzhu-research/iclr2026-cao-prompt-drift-lab}. 
